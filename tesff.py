...
def listen_print_loop(responses):
    ...
    for response in responses:
        ...
        with open("ww.txt",'w',encoding="utf-8") as fw:
            ...
            # if len(firstline1)<24:
            #     fw.write(firstline1)
            # elif len(firstline1)>24 and len(firstline1)<48:
            #     fw.write(firstline1[0:24]+"\n"+firstline1[23:])
            # else:
            #     fw.write(firstline1[48:72]+"\n"+firstline1[73:])
            n=int(len(firstline1)/48)
            k=n*48
            fw.write(firstline1[k:k+23]+"\n"+firstline1[k+23:])
        ...
        if not result.is_final:
            ...
            print(transcript + overwrite_chars+"12333")
